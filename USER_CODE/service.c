...
void Init_Service_DDLV(sint32 op)
{
	...
	Set_Chr_Color(COL_WHITE,COL_BLACK);
	Put_Line_Str( 200,40,Language_Str("电导率电路测试","DDLV AD TEST")); 
	...
	Set_Chr_Color(COL_BLACK,COL_THINBLUE);
	Put_Line_Str( Language_Pos(80,80),115,Language_Str("切换电源通道",  "POWER SWITCH"));
	Put_Line_Str( Language_Pos(80,80),165,Language_Str("切换反馈电阻",  "RES SWITCH"));
	//Put_Line_Str( Language_Pos(150,150),265,Language_Str("停止",  "STOP"));
